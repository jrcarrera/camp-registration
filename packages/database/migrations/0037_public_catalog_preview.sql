CREATE OR REPLACE FUNCTION get_public_catalog(requested_slug text)
RETURNS TABLE (
...
LANGUAGE sql STABLE SECURITY DEFINER SET search_path = pg_catalog AS $$
  WITH selected_org AS (
    ...
    WHERE o.slug = requested_slug
      AND (o.public_catalog_enabled OR current_setting('app.public_catalog_preview', true) = 'true')
  ), public_sessions AS (
